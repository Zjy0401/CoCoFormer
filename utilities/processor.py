...
def decode_midi(idx_array, file_path=None):
    event_sequence = [Event.from_int(idx) for idx in idx_array]  # convert to events
...
if __name__ == '__main__':
    encoded = encode_midi('bin/MIDI-Unprocessed_Chamber1_MID--AUDIO_07_R3_2018_wav--2.midi')
    print(encoded)
    decided = decode_midi(encoded, file_path='bin/test.mid')

    ins = pretty_midi.PrettyMIDI('bin/MIDI-Unprocessed_Chamber1_MID--AUDIO_07_R3_2018_wav--2.midi')
    print(ins)
